...
# Tạo thư mục cho nginx và log, đảm bảo quyền cho root (fix lỗi không start được nginx)
RUN mkdir -p /var/run/nginx /var/log/nginx && chmod -R 777 /var/run/nginx /var/log/nginx
